...
async def cloud_only_analysis(query: str, pdf_text: str, model_id: str = "llama3-70b-8192") -> Dict[str, Any]:
...
async def hackathon_endpoint(
    ...
    try:
        ...
        for i, question in enumerate(request.questions):
            ...
            result_primary = await cloud_only_analysis(question, pdf_text, model_id="llama3-70b-8192")
            ...
            if result_primary.get("success", False) and result_primary.get("confidence_score", 0.0) >= 0.4:
                ...
                result_fallback = await cloud_only_analysis(question, pdf_text, model_id="llama-3.3-70b-versatile")
