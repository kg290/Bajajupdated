...
async def cloud_only_analysis(query: str, pdf_text: str, model_id: str = "qwen/qwen3-32b") -> Dict[str, Any]:
...
async def hackathon_endpoint(
    ...
    try:
        ...
        for i, question in enumerate(request.questions):
            ...
            result_primary = await cloud_only_analysis(question, pdf_text, model_id="qwen/qwen3-32b")
